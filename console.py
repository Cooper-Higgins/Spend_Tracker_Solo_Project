...
category_repository.create(category_bills)
...
transaction_1 = Transaction(35.00, 'FanDuel', 'Gaming', '01/04/2023 16:58:01', user_1)
transaction_repository.create(transaction_1)
transaction_2 = Transaction(10.00, 'Lidl', 'Supermarkets', '02/04/2023 17:48:59', user_1)
transaction_repository.create(transaction_2)
transaction_3 = Transaction(3.00, 'SPT', 'Transport', '03/04/2023 21:05:10', user_1)
transaction_repository.create(transaction_3)
transaction_4 = Transaction(2.50, 'Andina', 'Cafés', '04/04/2023 08:31:45', user_1)
...
transaction_8 = Transaction(120.00, 'Octopus', 'Utilities', '06/04/2023 02:00:00', user_1)
transaction_repository.create(transaction_8)
transaction_9 = Transaction(242.68, 'Skyscanner', 'Travel', '07/04/2023 12:01:58', user_1)
